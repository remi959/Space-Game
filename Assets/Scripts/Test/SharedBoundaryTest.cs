...
/// <summary>
/// Test scene for the shared boundary chunk system.
/// Attach this to an empty GameObject in your scene.
/// 
/// Setup Instructions:
/// 1. Create a new scene
/// 2. Create an empty GameObject named "PlanetTest"
/// 3. Attach this script to it
/// 4. Create a ShapeSettings asset (Right-click > Create > Planet > Shape Settings)
/// 5. Configure the ShapeSettings (see recommended values below)
/// 6. Assign the ShapeSettings to this script
/// 7. Create a material for the terrain
/// 8. Assign the material to this script
/// 9. Press Play
/// 
/// Controls:
...
/// </summary>
public class SharedBoundaryTest : MonoBehaviour
{
    [Header("Required References")]
    [Tooltip("Create via Right-click > Create > Planet > Shape Settings")]
    public ShapeSettings shapeSettings;

    public CaveSettings caveSettings;
    
    [Tooltip("Any material - a simple color material works")]
